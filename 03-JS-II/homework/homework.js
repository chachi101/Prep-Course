...
function mayoriaDeEdad(edad) {
  ...
  if (edad > 17) return 'Allowed'; else return 'Not allowed';
}
...
function esEntero(numero) {
  ...
  // Tu código:
  if ((Math.floor(numero) == numero) || numero == 0) return true;
  return false;
}
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  if((numero < 1000 && numero > 99) || (numero < -99 && numero > -1000)) return true;
  return false;
}
...
function doWhile(numero) {
  ...
  let i = 1;
  do {i = i + 1; numero = numero + 5;} while (i < 9);
  return numero;
}
